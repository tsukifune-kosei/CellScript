...
schema 68, source schema 2, artifact schema 1, and constraints schema 4. Runtime
metadata binds the closed `cellscript-ckb-runtime-view-v1` contract.
...
and remain in current metadata schema 68 on the `0.30` development branch. Audit the
...
retained by current metadata schema 68 on the `0.30` development branch as
