...
- call `wait_for_protocol_bundle_confirmation` with an explicit minimum depth
  and bounded poll policy; retain the inclusion/tip/reorg snapshot and do not
  upgrade it to an absolute-finality claim.
